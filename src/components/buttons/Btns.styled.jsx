...
export const Btn5 = styled.button`
  ...
  -webkit-box-shadow: inset 0px 0px 0.5em 0px #32a7bc, 0px 0px 0.5em 0px #42abbe;
...
export const Span1 = styled.span`
  float: left;
  margin-right: -0.8em;
  -webkit-text-shadow: 0 0 0.125em hsl(0 0% 100% / 0.3), 0 0 0.45em #26282a;
  -moz-text-shadow: 0 0 0.125em hsl(0 0% 100% / 0.3), 0 0 0.45em #1d8ace;
...
export const Btn6 = styled.button`
  ...
  text-shadow: calc(var(--_i, -1) * 0.08em) -0.01em 0 #fff,
...
export const Btn8 = styled.button`
  ...
  border: rgba(235, 97, 143, 1) 3px solid;
  padding: 0.25em 1em;
  border-radius: 0.25em;

  text-shadow: 0 0 0.125em rgba(255, 255, 255, 0.55), 0 0 0.2em currentColor;

  box-shadow: inset 0 0 0.2em 0 rgba(235, 97, 143, 1),
    0 0 0.2em 0 rgba(235, 97, 143, 1);
  ...
  ::before {
    ...
    transform: perspective(1em) rotateX(30deg) scale(1.5, 0.5);
    filter: blur(1em);
    opacity: 0.7;
